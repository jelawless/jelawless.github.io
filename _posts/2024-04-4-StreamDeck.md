...
Description
: The Raspberry Pi Pico is a low-cost, high-performance microcontroller board featuring the RP2040 chip. It was selected for this project due to its native USB support, ample GPIO pins, and excellent compatibility with CircuitPython. CircuitPython allows the Pico to appear as a USB mass storage device, making code updates as simple as editing a Python file. ![Pico Image](/pictures/pico/pico_board.webp){: width="300" .w-50 .right}
...
Description
: An EC11-type rotary encoder allows for incremental adjustments (like volume control) and often includes a push-button switch (used here for play/pause). It provides a versatile input method beyond simple key presses. ![Encoder Image](/pictures/pico/rotary_encoder.jpg){: width="300" .w-50 .right} <!-- Placeholder Image -->
...
For those interested in building their own PicoDeck, a more comprehensive step-by-step guide, including KiCad project files, and CircuitPython code examples, will be made available.
...
- [Link to Guide](https://github.com/jelawless/PicoStreamDeck/blob/main/KiCAD_How_To.pdf)
{: .prompt-success }